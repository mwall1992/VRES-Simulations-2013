...
sol_init = lattice_profile_00_init;
...
for i = 0:realisationMaxIndex
    eval(['sol_200_avg = sol_200_avg + lattice_profile_00_0_' num2str(i) '(:);']);
end
...
for i = 0:realisationMaxIndex
    eval(['sol_500_avg = sol_500_avg + lattice_profile_00_0_' num2str(i) '(:);']);
end
...
for i = 0:realisationMaxIndex
    eval(['sol_1000_avg = sol_1000_avg + lattice_profile_00_0_' num2str(i) '(:);']);
end
...
title('Average Agent Densities (c0 = 1, max delta = 0.0, realisations = 2000)', ...
    'FontWeight', 'Bold');
xlabel('x');
