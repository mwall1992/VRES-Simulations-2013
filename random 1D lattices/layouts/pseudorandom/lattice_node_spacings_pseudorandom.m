...
node_positions_rand_20_1 = sort(node_positions_rand_20_1);
node_positions_rand_20_2 = sort(node_positions_rand_20_2);
node_positions_rand_20_3 = sort(node_positions_rand_20_3);
node_positions_rand_20_4 = sort(node_positions_rand_20_4);
node_positions_rand_20_5 = sort(node_positions_rand_20_5);

%% Extract node spacing information
nodeCount = max(size(node_positions_rand_20_1));

nodeSpacings = zeros(nodeCount-1, 5);
nodeSpacings(:, 1) = node_positions_rand_20_1(2:nodeCount) ...
    - node_positions_rand_20_1(1:(nodeCount-1))
nodeSpacings(:, 2) = node_positions_rand_20_2(2:nodeCount) ...
    - node_positions_rand_20_2(1:(nodeCount-1));
nodeSpacings(:, 3) = node_positions_rand_20_3(2:nodeCount) ...
    - node_positions_rand_20_3(1:(nodeCount-1));
nodeSpacings(:, 4) = node_positions_rand_20_4(2:nodeCount) ...
    - node_positions_rand_20_4(1:(nodeCount-1));
nodeSpacings(:, 5) = node_positions_rand_20_5(2:nodeCount) ...
    - node_positions_rand_20_5(1:(nodeCount-1));
