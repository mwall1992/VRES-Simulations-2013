...
load('net_displacement_multi_agents_perturbed_single_lattice.mat');

%% Update lattice information
realisations = 100;

bounds = {'05', '10', '20', '30', '40', '50'};
...
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'std dev = 0.05 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'std dev = 0.1 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'std dev = 0.2 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'std dev = 0.3 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'std dev = 0.4 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'std dev = 0.5 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
spacings = node_positions_0_05_0(2:end, 1) - node_positions_0_05_0(1:end-1, 1);
avgSpacing = sum(spacings) / (max(size(node_positions_0_05_0)) - 1);
disp('-------------------------------------------');
disp('Lattice information (std dev = 0.05):');
