...
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'Max Delta = 0.1 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'Max Delta = 0.2 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'Max Delta = 0.3 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'Max Delta = 0.4 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
...
xlabel('Time');
title(['Average Displacement of Tracked Agent (Perturbed Lattice with ' ...
    'Max Delta = 0.5 and 100 Simulations)']);
legend('X_t - X_0', 'S_t');
